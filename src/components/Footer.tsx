...
export default function Footer() {
  ...
  return (
    <footer className="relative bg-[#050505] border-t border-white/10 pt-20 pb-10 overflow-hidden">
      {/* Background glow orb */}
      <div className="absolute bottom-0 right-0 w-[400px] h-[400px] bg-[#c9f731]/5 rounded-full blur-[100px] pointer-events-none" />
      ...
      <div className="max-w-7xl mx-auto px-6 md:px-16 relative z-10">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-16">
            ...
            <div className="flex items-center gap-3">
              {[
                ...
                <a
                  ...
                  className="w-9 h-9 rounded-full border border-white/10 flex items-center justify-center text-neutral-400 hover:border-[#c9f731] hover:text-[#c9f731] transition-all bg-white/5"
                >
                  {social.icon}
                </a>
              ))}
          ...
          {/* Quick Navigation */}
          <div>
            <h3 className="font-mono text-xs text-[#c9f731] uppercase tracking-[0.2em] mb-6">Expertise Pages</h3>
            <ul className="space-y-3.5 text-sm text-neutral-400 font-mono">
              {[
                ...
                <li key={link.href}>
                  <Link href={link.href} className="hover:text-[#c9f731] transition-colors flex items-center gap-1 group">
          ...
          <div>
            <h3 className="font-mono text-xs text-[#c9f731] uppercase tracking-[0.2em] mb-6">Contact & Location</h3>
            <ul className="space-y-4 text-sm text-neutral-400">
              ...
              <li className="flex items-center gap-3">
                <Mail className="w-5 h-5 text-[#c9f731] flex-shrink-0" />
                <a href="mailto:khorrum@pro.bd" className="hover:text-[#c9f731] transition-colors font-mono">
                  khorrum@pro.bd
                </a>
              </li>
              <li className="flex items-center gap-3">
                <Phone className="w-5 h-5 text-[#c9f731] flex-shrink-0" />
                <a href="https://wa.me/8801700000000" target="_blank" rel="noopener noreferrer" className="hover:text-[#c9f731] transition-colors font-mono">
                  +880 WhatsApp Chat
                </a>
              </li>
            </ul>
          ...
          <div>
            <h3 className="font-mono text-xs text-[#c9f731] uppercase tracking-[0.2em] mb-6">SEO Newsletter</h3>
            <p className="text-sm text-neutral-400 mb-4 leading-relaxed">
              Get bi-weekly technical SEO audits and growth checklists delivered to your inbox.
            </p>
            {subscribed ? (
              <div className="p-4 rounded-xl bg-[#c9f731]/10 border border-[#c9f731]/30 text-xs text-[#c9f731] font-mono">
              ...
              <form onSubmit={handleSubscribe} className="relative">
                <input
                  ...
                  required
                  className="w-full bg-[#111111] border border-white/10 rounded-xl px-4 py-3 text-xs text-white placeholder-neutral-600 focus:outline-none focus:border-[#c9f731] transition-all font-mono"
                />
                <button
                  type="submit"
                  className="absolute right-2 top-1/2 -translate-y-1/2 w-8 h-8 rounded-lg bg-[#c9f731] text-[#050505] flex items-center justify-center hover:bg-[#b8e220] transition-colors"
