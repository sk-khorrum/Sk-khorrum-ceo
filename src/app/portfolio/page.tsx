    ...
    <main className="relative min-h-screen text-white bg-[#050505] selection:bg-[#c9f731] selection:text-[#050505] overflow-x-hidden pt-28 pb-20">
      ...
      <div className="max-w-7xl mx-auto px-6 md:px-16 z-10 relative">
        ...
        <nav className="text-xs font-mono text-neutral-500 mb-8 flex items-center gap-2">
          ...
          <span>/</span>
          <span className="text-[#c9f731]">PORTFOLIO</span>
        </nav>

        {/* Title */}
        <div className="flex flex-col lg:flex-row lg:items-end justify-between gap-6 mb-16">
          <div>
            <span className="text-[#c9f731] font-mono text-xs uppercase tracking-[0.25em] mb-3 block">Showcase of Search Execution</span>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-20">
          {filteredProjects.map((proj) => (
            <div 
              key={proj.id}
              className="group p-8 rounded-[32px] bg-[#111]/40 border border-white/8 hover:border-[#c9f731]/30 transition-all duration-300 flex flex-col justify-between"
            >
              <div className="space-y-6">
                <div className="flex items-center justify-between text-xs font-mono text-neutral-500">
                  <span className="uppercase">{proj.category}</span>
                  <span className="px-2.5 py-0.5 rounded bg-[#c9f731]/10 text-[#c9f731] font-bold uppercase tracking-wider text-[9px] border border-[#c9f731]/20">
                    {proj.growth}
                  </span>
                </div>

                <div className="space-y-2">
                  <h3 className="text-xl font-bold text-white group-hover:text-[#c9f731] transition-colors">
                    {proj.title}
                  </h3>
              ...
              <div className="mt-8 pt-6 border-t border-white/5 space-y-4">
                <div className="text-neutral-400 italic text-xs leading-relaxed pl-4 border-l-2 border-[#c9f731]">
                  "{proj.review}"
                </div>
                <div className="flex items-center justify-between text-[11px] font-mono">
                  ...
                  <Link 
                    href={proj.link} 
                    className="text-[#c9f731] hover:underline flex items-center gap-0.5"
                  >
