    ...
    <main className="relative min-h-screen text-white bg-[#050505] selection:bg-[#c9f731] selection:text-[#050505] overflow-x-hidden pt-28 pb-20">
      ...
      <div className="max-w-7xl mx-auto px-6 md:px-16 z-10 relative">
        ...
        <nav className="text-xs font-mono text-neutral-500 mb-8 flex items-center gap-2">
          ...
          <span>/</span>
          <span className="text-[#c9f731]">REVIEWS</span>
        </nav>

        {/* Title */}
        <div className="mb-16 text-center max-w-2xl mx-auto space-y-4">
          <span className="text-[#c9f731] font-mono text-xs uppercase tracking-[0.25em]">Verified Client Feedback</span>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-16 max-w-4xl mx-auto">
          <div className="p-6 rounded-2xl bg-white/5 border border-white/8 text-center space-y-1">
            <div className="flex justify-center text-[#c9f731] mb-2">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mb-20">
          {reviews.map((rev, idx) => (
            <div 
              key={idx}
              className="p-8 rounded-3xl bg-[#111]/40 border border-white/8 flex flex-col justify-between hover:border-[#c9f731]/30 transition-all duration-300 relative"
            >
              <Quote className="absolute top-6 right-8 w-12 h-12 text-[#c9f731]/5 pointer-events-none" />

              <div className="space-y-4">
                {/* Rating */}
                <div className="flex gap-1 text-[#c9f731]">
